...
% 
% Judul laporan. 
\var{\judul}{Implementasi ZigBee \textit{Gateway} Berbasis GUI Menggunakan Raspberry Pi}
% 
% Tulis kembali judul laporan, kali ini akan diubah menjadi huruf kapital
\Var{\Judul}{Implementasi ZigBee \textit{Gateway} Berbasis GUI menggunakan Raspberry Pi}
% 
% Tulis kembali judul laporan namun dengan bahasa Ingris
\var{\judulInggris}{GUI Based ZigBee Gateway Implementation using Raspberry Pi}
